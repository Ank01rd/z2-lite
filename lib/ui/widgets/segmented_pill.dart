...
/// и катается через AnimatedAlign. Колёсико мыши листает значения по кругу.
class SegmentedPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Listener(
      // колёсико: вниз — следующее значение, вверх — предыдущее (по кругу)
      onPointerSignal: (e) {
        if (e is PointerScrollEvent && n > 1) {
